...
export type InteractableType = 'ConversationArea' | 'ViewingArea' | 'TicTacToeArea' | 'MuseumArea';
...
export type InteractableCommand =  ViewingAreaUpdateCommand | JoinGameCommand | GameMoveCommand<TicTacToeMove> | LeaveGameCommand | LeaveReviewCommand;
...
export interface LeaveReviewCommand {
  type: 'LeaveReview';
  review: string;
}
...
export type InteractableCommandReturnType<CommandType extends InteractableCommand> = 
  ...
  CommandType extends LeaveReviewCommand ? undefined :
  never;
